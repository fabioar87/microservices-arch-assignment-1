...
create TABLE IF NOT EXISTS customerservice.order_item (
    ...
    REFERENCES customerservice.orders(id),
    FOREIGN KEY(item_id)
 ...
 */
insert into customerservice."customer" (id, username, first_name, last_name, email, phone, user_status) values('a1b9b31d-e73c-4112-af7c-b68530f38222', 'tech_guru42', 'Alice', 'Johnson', 'alice.johnson@example.com', '+1-555-1234', 'ACTIVE');
insert into customerservice."customer" (id, username, first_name, last_name, email, phone, user_status) values('a1b9b31d-e73c-4112-af7c-b68530f38223', 'datacenter_master', 'Bob', 'Williams', 'bob.williams@example.com', '+1-555-5678', 'ACTIVE');
...
insert into customerservice.orders(id, customer_id, order_date, total, status) values('0a59ba9f-629e-4445-8129-b9bce1985d6a','a1b9b31d-e73c-4112-af7c-b68530f38222', current_timestamp, 10000.00, 'CREATED');
